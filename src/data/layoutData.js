...
export const rentMenu = [
  { text: "Коттеджи и усадьбы", key: "rent-menu-1", link: CATALOG_PATH },
  { text: "Бани и cауны", key: "rent-menu-2", link: CATALOG_PATH },
  { text: "Авто напрокат", key: "rent-menu-3", link: CATALOG_PATH },
];
